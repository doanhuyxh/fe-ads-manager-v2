//app/api/external/get_all_fb_fetch_campaign_data_v20
...
export async function GET(req: NextRequest) {
    ...
    const data = await fetch(`${process.env.NEXT_PUBLIC_EXTERNAL_API}/fetch_campaign_data_v20?since=${since}&until=${until}`, {
        method: "GET",
        headers: {
